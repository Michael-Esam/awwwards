    ...
    <div className="relative size-full">
      ...
      <div className="relative z-10 flex size-full flex-col justify-between p-5 text-blue-50">
        <div>
          ...
          {description && (
            <p className="mt-3 max-w-64 text-xs md:text-base mb-[10px]">
              {description}
            </p>
          )}
        </div>
            ...
            <div
              ...
              style={{
                ...
                background: `radial-gradient(
                  100px circle at ${cursorPosition.x}px ${cursorPosition.y}px,
                  #656fe288,
                  #00000026
                )`,
              }}
...
const Features = (): JSX.Element => (
  <section id="vault" className="bg-black pb-52">
    <div className="container mx-auto px-3 md:px-10">
      ...
      <div className="grid h-fit w-full grid-cols-2 grid-rows-3 gap-7">
        <BentoTilt className="bento-tilt_1  md:col-span-1 row-span-2">
          <BentoCard
